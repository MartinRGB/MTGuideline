...
var WebSlides = function () {
  ...
  _createClass(WebSlides, [{
    ...
    // if(slide.i != 2){
    //   var slideDiv = document.getElementsByClassName('slide-track')[0];
    //   slideDiv.style.animation = 'scroll 0s linear infinite'
    // }

    // if(slide.i == 2){
    //   var slideDiv = document.getElementsByClassName('slide-track')[0];
    //   slideDiv.style.animation = 'scroll 20s linear infinite'
    // }


      if(slide.i != Number(slide.parent.childElementCount) - 3){
